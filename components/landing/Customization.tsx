      ...
      <div className="w-full md:w-1/2 py-4 md:py-4 md:px-4">
        ...
        <div className="grid grid-cols-2 md:gap-4 ">
          <div className="flex flex-col items-center justify-center p-4">
            <PaintBrushIcon className="w-10 h-10 mb-2 text-indigo-500" />
          ...
          <div className="flex flex-col items-center justify-center p-4">
            <LockClosedIcon className="w-10 h-10 mb-2 text-indigo-500" />
          ...
          <div className="flex flex-col items-center justify-center p-4">
            <CubeIcon className="w-10 h-10 mb-2 text-indigo-500" />
          ...
          <div className="flex flex-col items-center justify-center p-4">
            <InformationCircleIcon className="w-10 h-10 mb-2 text-indigo-500" />
