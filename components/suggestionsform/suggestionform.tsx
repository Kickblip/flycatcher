              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Add a Darkmode" {...field} style={{ backgroundColor: board.secondaryColor }} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <CardContent>
          {suggestions.length > 0 ? (
            suggestions.map((suggestion, index) => (
              <Card key={index} className="mt-4 relative" style={{ backgroundColor: board.secondaryColor }}>
                <CardHeader>
                ...
                <div className="absolute top-0 right-0 flex items-center">
                  ...
                  <div className="flex flex-col">
                    <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => onClickVoteUp(index, 1)}>
                ...
                <CardContent>
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="sm:max-w-[1000px]" style={{ backgroundColor: board.primaryColor }}>
                      ...
                      <Form {...commentForm}>
                        <form
                          onSubmit={commentForm.handleSubmit((values) => onSubmitComment(index, values.comment))}
                          className="space-y-8"
                        >
                          <FormField
